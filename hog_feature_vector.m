...
dbf=feature/sqrt(norm(feature)^2+.001);  
dbfeat(:,iii)=abs(sum(dbf));

end
dbfeat_per=dbfeat(:,1:iii/2);
dbfeat_noper=dbfeat(:,iii/2:iii);
save dbfeat_per dbfeat_per
save dbfeat_noper dbfeat_noper
save dbfeat dbfeat

helpdlg('Database Loading is Complited');
